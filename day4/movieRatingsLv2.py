...
#film_rating = "12a"
film_ratingList = ["universal", "pg", "12", "12a", "15", "18"]

def loopBack():
    userIn = input("Would you like to check another movie rating? Y/N\n")
    if userIn.lower() == "y":
        return True
    elif userIn.lower() == "n":
        return False
...
while True:
    print(f"here is a list of film ratings to pick from: {film_ratingList}")
    film_rating = input("Enter your movie rating: ")
